...
![OpenSSH logo](https://raw.githubusercontent.com/kkadams1961/sftp/master/openssh.png "Powered by OpenSSH")

# Supported tags and respective `Dockerfile` links

- [`debian`, `latest` (*Dockerfile*)](https://github.com/kkadams1961/sftp/blob/main/Dockerfile)
- [`alpine` (*Dockerfile*)](https://github.com/kkadams1961/sftp/blob/main/Dockerfile-alpine) 
- [`alpine-arm` (*Dockerfile*)](https://github.com/kkadams1961/sftp/blob/main/Dockerfile-alpine-arm)
...
```
docker run -p 22:22 -d kna/sftp-arm foo:pass:::upload
```
